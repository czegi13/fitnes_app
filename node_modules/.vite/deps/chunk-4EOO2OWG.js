...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = h(false);
...
`;
var TouchRipple = w(function TouchRipple2(inProps, ref) {
  ...
  const ignoringMouseDown = A(false);
  const startTimer = useTimeout();
  const startTimerCommit = A(null);
  const container = A(null);
  const startCommit = q((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, u(TouchRippleRipple, {
      classes: {
  ...
  const start = q((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  return u(TouchRippleRoot, {
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container,
    ...other,
    children: u(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = w(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return u(ButtonBaseRoot, {
    ...
    ...buttonProps,
    ...other,
    children: [children, enableTouchRipple ? u(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
//# sourceMappingURL=chunk-4EOO2OWG.js.map
