...
var TransitionGroupContext_default = xn.createContext(null);

// node_modules/react-transition-group/esm/utils/ChildMapping.js
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && fn(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2) I.map(children2, function(c) {
    return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    var isLeaving = fn(prevChild) && !prevChild.props.in;
    ...
    } else if (hasNext && hasPrev && fn(prevChild)) {
      children2[key] = sn(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return xn.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return xn.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, xn.createElement(Component, props, children2));
  };
...
var Transition = function(_React$Component) {
  ...
  _proto.performEnter = function performEnter(mounting) {
    ...
    var _ref2 = this.props.nodeRef ? [appearing] : [xn.findDOMNode(this), appearing], maybeNode = _ref2[0], maybeAppearing = _ref2[1];
  ...
  _proto.performExit = function performExit() {
    ...
    var timeouts = this.getTimeouts();
    var maybeNode = this.props.nodeRef ? void 0 : xn.findDOMNode(this);
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      xn.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children2 === "function" ? children2(status, childProps) : xn.cloneElement(xn.Children.only(children2), childProps))
    );
  };
  return Transition2;
}(xn.Component);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return xn.createElement(Transition_default, _extends({}, props, {
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = xn.Children.toArray(children2)[idx];
    if (child.props[handler]) (_child$props = child.props)[handler].apply(_child$props, originalArgs);
    if (this.props[handler]) {
      var maybeNode = child.props.nodeRef ? void 0 : xn.findDOMNode(this);
      this.props[handler](maybeNode);
    }
  };
  _proto.render = function render() {
    var _this$props = this.props, children2 = _this$props.children, inProp = _this$props.in, props = _objectWithoutPropertiesLoose(_this$props, ["children", "in"]);
    var _React$Children$toArr = xn.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return xn.createElement(TransitionGroup_default, props, inProp ? xn.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : xn.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (xn.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
function areChildrenDifferent(oldChildren, newChildren) {
  ...
  if (xn.isValidElement(oldChildren) && xn.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return xn.cloneElement(current, {
    in: false,
  ...
  return [current, xn.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return xn.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, xn.cloneElement(children2, {
        in: true
      }));
    })
  });
...
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: xn.cloneElement(props.children, {
        in: true
      })
    };
  };
...
//# sourceMappingURL=chunk-NXN5QXIY.js.map
