import {
  ...
  x,
  y
} from "./chunk-OG4TIAGF.js";
import {
  u
} from "./chunk-I5IRDDS4.js";
import {
  B,
  D,
  E,
...
function C(n, e) {
  function r2(n2) {
    ...
    return !r3 && t && (t.call ? t(null) : t.current = null), e ? !e(this.props, n2) || !r3 : g2(this.props, n2);
  }
  function u2(e2) {
...
(E2.prototype = new k()).isPureReactComponent = true, E2.prototype.shouldComponentUpdate = function(n, t) {
  return g2(this.props, n) || g2(this.state, t);
};
var x2 = l.__b;
l.__b = function(n) {
...
var I = { map: k2, forEach: k2, count: function(n) {
...
function T2(n, t, e) {
  ...
  }), n.__c.__H = null), null != (n = function(n2, t2) {
    for (var e2 in t2) n2[e2] = t2[e2];
    return n2;
  }({}, n)).__c && (n.__c.__P === e && (n.__c.__P = t), n.__c = null), n.__k = n.__k && n.__k.map(function(n2) {
    return T2(n2, t, e);
  })), n;
}
function A2(n, t, e) {
...
l.unmount = function(n) {
  var t = n.__c;
  t && t.__R && t.__R(), t && 32 & n.__u && (n.type = null), M && M(n);
}, (D2.prototype = new k()).__c = function(n, t) {
  var e = t.__c, r2 = this;
  null == r2.t && (r2.t = []), r2.t.push(e);
  var u2 = L(r2.__v), o = false, i = function() {
    o || (o = true, e.__R = null, u2 ? u2(c) : c());
  };
  e.__R = i;
  var c = function() {
    if (!--r2.__u) {
      if (r2.state.__a) {
        var n2 = r2.state.__a;
        r2.__v.__k[0] = A2(n2, n2.__c.__P, n2.__c.__O);
      }
      var t2;
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = T2(this.__b, r2, o.__O = o.__P);
    }
    this.__b = null;
  }
...
function W(n) {
  ...
  }, e.i && e.i !== r2 && e.componentWillUnmount(), e.l || (e.i = r2, e.l = { nodeType: 1, parentNode: r2, childNodes: [], contains: function() {
    return true;
  ...
  } }), B(_(V, { context: e.context }, n.__v), e.l);
}
function P2(n, e) {
  var r2 = _(W, { __v: n, i: e });
  return r2.containerInfo = e, r2;
}
(F2.prototype = new k()).__a = function(n) {
  var t = this, e = L(t.__v), r2 = t.o.get(n);
  return r2[0]++, function(u2) {
    var o = function() {
      t.props.revealOrder ? (r2.push(u2), U(t, n, r2)) : u2();
    };
    e ? e(o) : o();
  };
}, F2.prototype.render = function(n) {
...
var z = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;
var B2 = /^on(Ani|Tra|Tou|BeforeInp|Compo)/;
var H2 = /[A-Z0-9]/g;
  ...
  "string" == typeof n.type && function(n2) {
    ...
    for (var i in t) {
      ...
      if (!("value" === i && "defaultValue" in t && null == c || Z && "children" === i && "noscript" === e || "class" === i || "className" === i)) {
        var f = i.toLowerCase();
        "defaultValue" === i && "value" in t && null == t.value ? i = "value" : "download" === i && true === c ? c = "" : "translate" === f && "no" === c ? c = false : "o" === f[0] && "n" === f[1] ? "ondoubleclick" === f ? i = "ondblclick" : "onchange" !== f || "input" !== e && "textarea" !== e || Y(t.type) ? "onfocus" === f ? i = "onfocusin" : "onblur" === f ? i = "onfocusout" : B2.test(i) && (i = f) : f = i = "oninput" : o && z.test(i) ? i = i.replace(H2, "-$&").toLowerCase() : null === c && (c = void 0), "oninput" === f && u2[i = f] && (i = "oninputCapture"), u2[i] = c;
      }
    }
    "select" == e && u2.multiple && Array.isArray(u2.value) && (u2.value = H(t.children).forEach(function(n3) {
      n3.props.selected = -1 != u2.value.indexOf(n3.props.value);
    })), "select" == e && null != u2.defaultValue && (u2.value = H(t.children).forEach(function(n3) {
      n3.props.selected = u2.multiple ? -1 != u2.defaultValue.indexOf(n3.props.value) : u2.defaultValue == n3.props.value;
    })), t.class && !t.className ? (u2.class = t.class, Object.defineProperty(u2, "className", nn)) : (t.className && !t.class || t.class && t.className) && (u2.class = u2.className = t.className), n2.props = u2;
...
l.diffed = function(n) {
  ...
  null != e && "textarea" === n.type && "value" in t && t.value !== e.value && (e.value = null == t.value ? "" : t.value), X = null;
};
var un = { ReactCurrentDispatcher: { current: { readContext: function(n) {
  return X.__n[n.__c].props.value;
}, useCallback: q, useContext: x, useDebugValue: P, useDeferredValue: _n, useEffect: y, useId: g, useImperativeHandle: F, useInsertionEffect: Sn, useLayoutEffect: _2, useMemo: T, useReducer: p, useRef: A, useState: h, useSyncExternalStore: En, useTransition: bn } } };
var on = "18.3.1";
function cn(n) {
...
var gn = fn;
function En(n, t) {
  var e = t(), r2 = h({ h: { __: e, v: t } }), u2 = r2[0].h, o = r2[1];
  return _2(function() {
    u2.__ = e, u2.v = t, Cn(u2) && o({ h: u2 });
  }, [n, e, t]), y(function() {
    return Cn(u2) && o({ h: u2 }), n(function() {
      Cn(u2) && o({ h: u2 });
    });
  }, [n]), e;
}
function Cn(n) {
  var t, e, r2 = n.v, u2 = n.__;
  try {
    var o = r2();
    return !((t = u2) === (e = o) && (0 !== t || 1 / t == 1 / e) || t != t && e != e);
  } catch (n2) {
    return true;
  }
}
var xn = { useState: h, useId: g, useReducer: p, useEffect: y, useLayoutEffect: _2, useInsertionEffect: Sn, useTransition: bn, useDeferredValue: _n, useSyncExternalStore: En, startTransition: yn, useRef: A, useImperativeHandle: F, useMemo: T, useCallback: q, useContext: x, useDebugValue: P, version: "18.3.1", Children: I, render: $, hydrate: q2, unmountComponentAtNode: hn, createPortal: P2, createElement: _, createContext: G, createFactory: cn, cloneElement: sn, createRef: m, Fragment: b, isValidElement: fn, isElement: gn, isFragment: ln, isMemo: an, findDOMNode: vn, Component: k, PureComponent: E2, memo: C, forwardRef: w, flushSync: pn, unstable_batchedUpdates: dn, StrictMode: mn, Suspense: D2, SuspenseList: F2, lazy: O, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: un };
...
function deepClone(source) {
  if (fn(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return fn(element) && muiNames.indexOf(
...
var useEnhancedEffect = typeof window !== "undefined" ? _2 : y;
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2) {
  ...
  for (var i = 0, j2 = 0, k3 = 0; i < index; ++i)
    for (var x3 = 0, y2 = substr(value, post + 1, post = abs(j2 = points[i])), z2 = value; x3 < size; ++x3)
...
var compat = function compat2(element) {
  ...
  for (var i = 0, k3 = 0; i < rules.length; i++) {
    for (var j2 = 0; j2 < parentRules.length; j2++, k3++) {
      element.props[k3] = points[i] ? rules[i].replace(/&\f/g, parentRules[j2]) : parentRules[j2] + " " + rules[i];
    }
  }
};
...
var useInsertionEffectWithLayoutFallback = useInsertionEffect || _2;

// node_modules/@emotion/react/dist/emotion-element-7a1343fa.browser.development.esm.js
var EmotionCacheContext = G(
...
var withEmotionCache = function withEmotionCache2(func) {
  return w(function(props, ref) {
    var cache2 = x(EmotionCacheContext);
...
var Emotion = withEmotionCache(
  ...
  function(props, cache2, ref) {
    ...
    var serialized = serializeStyles(registeredStyles, void 0, x(ThemeContext));
    ...
    return _(b, null, _(Insertion, {
      cache: cache2,
      serialized,
      isStringTag: typeof WrappedComponent === "string"
    }), _(WrappedComponent, newProps));
  }
);
{
...
var Global = withEmotionCache(function(props, cache2) {
  ...
  var serialized = serializeStyles([styles], void 0, x(ThemeContext));
  var sheetRef = A();
...
var ClassNames = withEmotionCache(function(props, cache2) {
  ...
  var content = {
    css: css2,
    cx,
    theme: x(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  return _(b, null, _(Insertion3, {
    cache: cache2,
    serializedArr
  }), ele);
});
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache2, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = x(ThemeContext);
      }
      if (typeof props.className === "string") {
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? u(CacheProvider, {
    value: cache,
    children
  }) : children;
}
...
function sortContainerQueries(theme, css2) {
  ...
  const sorted = Object.keys(css2).filter((key) => key.startsWith("@container")).sort((a, b3) => {
    var _a, _b;
    const regex = /min-width:\s*([0-9.]+)/;
    return +(((_a = a.match(regex)) == null ? void 0 : _a[1]) || 0) - +(((_b = b3.match(regex)) == null ? void 0 : _b[1]) || 0);
  });
  if (!sorted.length) {
    return css2;
  }
...
function useTheme2(defaultTheme5 = null) {
  const contextTheme = x(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = w(function Box3(inProps, ref) {
...
function hslToRgb(color2) {
  ...
  const f = (n, k3 = (n + h2 / 30) % 12) => l2 - a * Math.max(Math.min(k3 - 3, 9 - k3, 1), -1);
  let type = "rgb";
...
function createContainer(options = {}) {
  ...
  const Container2 = w(function Container3(inProps, ref) {
...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = q(() => defaultMatches, [defaultMatches]);
...
function useTheme4() {
  const theme = x(ThemeContext_default);
  if (true) {
    P(theme);
  }
  return theme;
...
function ThemeProvider2(props) {
  ...
  return u(ThemeContext_default.Provider, {
    value: theme,
    children
  });
}
...
var PropsContext = G(void 0);
function DefaultPropsProvider({
  value,
  children
}) {
  return u(PropsContext.Provider, {
    value,
    children
  });
}
...
function ThemeProvider3(props) {
  ...
  return u(ThemeProvider_default, {
    theme: privateTheme,
    children: u(ThemeContext.Provider, {
      value: engineTheme,
      children: u(RtlProvider_default, {
        value: rtlValue,
        children: u(DefaultPropsProvider_default, {
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = h(false);
  const hasMounted = A(false);
  y(() => {
    if (isMultiSchemes) {
      setHasMounted(true);
    }
  ...
  const handleMediaQuery = q((event) => {
  ...
  const mediaListener = A(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => x(ColorSchemeContext) || defaultContext;
  function CssVarsProvider(props) {
    ...
    const ctx = x(ColorSchemeContext);
    ...
    const allColorSchemes = T(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = u(b, {
      children: [u(ThemeProvider_default2, {
        themeId: scopedTheme ? themeId : void 0,
        theme: resolveTheme ? resolveTheme(theme) : theme,
        children
      }), shouldGenerateStyleSheet && u(GlobalStyles, {
    ...
    return u(ColorSchemeContext.Provider, {
      value: contextValue,
      children: element
    });
  }
...
function createGrid(options = {}) {
  ...
  const Grid2 = w(function Grid3(inProps, ref) {
    ...
    return u(GridRoot, {
      ...
      className: clsx_default(classes.root, className),
      ...other,
      children: I.map(children, (child) => {
        var _a;
        if (fn(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
          return sn(child, {
...
function joinChildren(children, separator) {
  const childrenArray = I.toArray(children).filter(Boolean);
...
function createStack(options = {}) {
  ...
  const Stack2 = w(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var excludeVariablesFromRoot = (cssVarPrefix) => [...[...Array(25)].map((_3, index) => `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}overlays-${index}`), `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}palette-AppBar-darkBg`, `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}palette-AppBar-darkColor`];
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JCNIGX4J.js.map
