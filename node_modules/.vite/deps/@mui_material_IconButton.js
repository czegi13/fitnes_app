...
var IconButton = w(function IconButton2(inProps, ref) {
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types.default.node, (props) => {
    const found = I.toArray(props.children).some((child) => fn(child) && child.props.onClick);
    if (found) {
